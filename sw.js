...
const CACHE_NAME = 'sportdata-v12';
const CACHE_URLS = [
  '/',
  '/index.html',
  '/style.css',
  '/app_offline.js',
  '/manifest.json',
  'https://fonts.googleapis.com/css2?family=Syne:wght@400;500;600;700;800&family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500&family=Orbitron:wght@500;700;800&display=swap',
];
